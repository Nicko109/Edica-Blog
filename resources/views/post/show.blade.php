...
@section('content')
    ...
    <main class="blog-post">
        <div class="container">
            ...
            <p class="edica-blog-post-meta">{{ $date->translatedFormat('F') }} {{ $date->day }}, {{ $date->year }} • {{ $date->format('H:i') }} • {{ $post->comments->count() }} Комментария</p>
            ...
            <div class="row">
                <div class="col-lg-9 mx-auto">
                    ...
                    <section class="comment-section">
                        <h2 class="section-title mb-5" leave="" a="" reply="">
